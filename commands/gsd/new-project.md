...
**Open the conversation with structured prompt:**
...
## The Jobs It Does
[The concrete workflows — what does a user actually DO with this?]
...
**If user provides structured response:** You have the context needed. Extract the jobs/workflows — these are critical for engineering decisions later. Proceed to follow-up questions.

**If user provides minimal response:** Probe for the missing pieces:
- "What are the concrete jobs this will do? Like 'User does X to achieve Y'?"
- "What's the core value — why does this need to exist?"
- "Any existing code, scripts, or references I should know about?"

**CRITICAL: Capture the Jobs.** The "Jobs It Does" section is essential. Without concrete workflows, Claude will understand the goal but not the mechanics — leading to questions mid-project that should have been answered upfront. Push for specifics:
